        ...
        <div className="container mx-auto px-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-center pb-12 text-right">
            ...
            <div className="flex gap-3 sm:gap-4 flex-wrap justify-center md:justify-end pr-0 md:pr-24 pb-16 md:pb-0" dir="ltr">
              <a href="https://www.youtube.com/@Englishom_sa" target="_blank" rel="noopener noreferrer" className="w-10 h-10 rounded-full bg-white/5 text-white/60 hover:text-white hover:bg-[#FF0000] flex items-center justify-center transition-all duration-300 hover:scale-110 hover:shadow-[0_0_15px_rgba(255,0,0,0.4)]" title="YouTube">
                <Youtube className="w-5 h-5" />
              </a>
              <a href="https://x.com/Englishom_sa" target="_blank" rel="noopener noreferrer" className="w-10 h-10 rounded-full bg-white/5 text-white/60 hover:text-white hover:bg-black flex items-center justify-center transition-all duration-300 hover:scale-110 hover:shadow-[0_0_15px_rgba(255,255,255,0.2)]" title="X">
              ...
              <a href="https://www.tiktok.com/@englishom_sa" target="_blank" rel="noopener noreferrer" className="w-10 h-10 rounded-full bg-white/5 text-white/60 hover:text-black hover:bg-[#25F4EE] flex items-center justify-center transition-all duration-300 hover:scale-110 hover:shadow-[0_0_15px_rgba(37,244,238,0.4)]" title="TikTok">
              ...
              <a href="https://www.facebook.com/share/1JunPviNMg/" target="_blank" rel="noopener noreferrer" className="w-10 h-10 rounded-full bg-white/5 text-white/60 hover:text-white hover:bg-[#1877F2] flex items-center justify-center transition-all duration-300 hover:scale-110 hover:shadow-[0_0_15px_rgba(24,119,242,0.4)]" title="Facebook">
