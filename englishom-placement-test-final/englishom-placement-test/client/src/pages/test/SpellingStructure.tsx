...
export default function SpellingStructure() {
  ...
  return (
    <div className="w-full max-w-2xl mx-auto p-6">
      <div className="mb-6">
        <h2 className="text-2xl font-bold mb-2">Spelling & Structure</h2>
      ...
      <div className="mb-6 p-4 bg-yellow-50 rounded-lg">
        <div className="text-center">
          ...
          <p className="text-4xl font-bold text-yellow-600">{timeLeft}s</p>
        </div>
      </div>
