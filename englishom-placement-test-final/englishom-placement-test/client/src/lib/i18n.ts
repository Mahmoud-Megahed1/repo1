...
export const translations = {
  en: {
    ...
    home: {
      ...
      subtitle: "Take our comprehensive placement test to determine your English proficiency level. Get instant results with personalized recommendations.",
      ...
      testStages: "Englishom Placement Test",
      stages: "Test Stages",
  ...
  ar: {
    ...
    // Home Page
    home: {
      title: "اكتشف مستواك في اللغة الإنجليزية",
      subtitle: "خذ اختبارنا الشامل لتحديد مستوى كفاءتك في اللغة الإنجليزية. احصل على النتائج الفورية مع توصيات مخصصة.",
      ...
      testStages: "اختبار تحديد المستوى من إنجليشوم",
      stages: "مراحل الاختبار",
      levels: "مستويات الكفاءة",
    ...
    // Results Page
    results: {
      yourResults: "نتائج الاختبار الخاصة بك",
