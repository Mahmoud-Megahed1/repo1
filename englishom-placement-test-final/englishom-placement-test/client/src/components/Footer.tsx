          ...
          >
            ...
            <p className="text-muted-foreground text-sm md:text-base leading-relaxed text-justify mb-2 whitespace-pre-line">
              {isAr ? (
                ...
                "This indicator is designed to read your current level, help you monitor your progress, and guide your next steps within the platform. It is an estimated technical reading and not a final or decisive standard; the goal is to support your self-practice and give you a clear and continuous view of your development."
              )}
            </p>
