...
type Admin = {
  ...
  settings: {
    ...
    repurchaseDiscounts: string;
    configureDiscount: string;
    courseDiscount: string;
    addDiscountLevel: string;
    saveSettings: string;
    savedSuccessfully: string;
  };
  aiSettings: {
    title: string;
    manageBehavior: string;
    ...
    enableGlobalSupportChat: string;
    enableLessonReviewAI: string;
    savedSuccessfully: string;
  };
  chatRules: {
    title: string;
