          ...
          <div className="space-y-2 max-w-3xl">
            ...
            <p className="text-muted-foreground text-sm md:text-base leading-relaxed">
              {isAr
                ...
                : `"Your precise metric to discover your true capabilities. At EnglishOM, we rely on advanced assessment systems to determine your comprehensive language proficiency, intelligently and reliably placing you on the optimal learning path."`}
            </p>
          </div>
