      ...
      <CardHeader className="w-full">
        <div className="flex items-center gap-4">
          ...
          <div className="rtl:space-y-1">
            <h2 className="text-xl font-bold md:text-2xl">{t('Global.idioms.examplesCard.title')}</h2>
            <CardDescription>{t('Global.idioms.examplesCard.description')}</CardDescription>
          </div>
        </div>
      </CardHeader>
