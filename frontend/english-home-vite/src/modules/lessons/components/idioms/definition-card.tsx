...
type Props = Pick<IdiomLesson, 'definitionEn' | 'definitionAr'>;
      ...
      <CardHeader className="w-full">
        <div className="flex items-center gap-4">
          ...
          <div className="rtl:space-y-1">
            <h2 className="text-xl font-bold md:text-2xl">{t('Global.idioms.definitionCard.title')}</h2>
            <CardDescription>{t('Global.idioms.definitionCard.description')}</CardDescription>
          </div>
        </div>
      </CardHeader>
