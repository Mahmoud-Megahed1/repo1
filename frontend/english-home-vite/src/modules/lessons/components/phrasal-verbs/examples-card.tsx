        ...
        <Card>
            <CardHeader className="w-full">
                <div className="flex items-center gap-4">
                    <div className={accordionVariants({ variant: 'purple' })}>
                        <MessageCircle className="h-6 w-6 text-white" />
                    </div>
                    <div className="rtl:space-y-1">
                        <h2 className="text-xl font-bold md:text-2xl">{t('Global.phrasalVerbs.examplesCard.title')}</h2>
                        <CardDescription>{t('Global.phrasalVerbs.examplesCard.description')}</CardDescription>
                    </div>
                </div>
            </CardHeader>
                ...
                <div className="grid grid-cols-1 gap-6 md:grid-cols-2 md:items-start">
                    ...
                    <div className="space-y-3">
                        <img
                            ...
                            className="mx-auto aspect-auto max-h-72 w-full rounded-xl object-contain"
                        />
