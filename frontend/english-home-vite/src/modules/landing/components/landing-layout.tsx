...
const WhatsAppFloat = () => (
  <a
    ...
    className="group fixed bottom-6 start-4 z-50 flex h-12 w-12 items-center justify-center rounded-full bg-[#25D366] text-white shadow-xl transition-all duration-300 hover:scale-110 hover:shadow-2xl md:bottom-6 md:start-6 md:h-14 md:w-14"
  >
