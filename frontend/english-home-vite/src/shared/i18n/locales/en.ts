...
export default {
  ...
  Global: {
    ...
    purchaseAgreement: {
      ...
      intro: 'This agreement constitutes an electronically binding contract between Englishom.com and the subscriber (referred to as "the Client"), and applies to all purchases and subscriptions to courses and educational services.',
      clause1Title: 'Acceptance and Consent',
      clause1Content: 'By completing the purchase or registration, the Client acknowledges that they have read and agreed to all terms and conditions and the privacy policy published on the website, and this consent is considered a final electronic signature.',
      clause2Title: 'Access Validity and Content',
      clause2Content: 'Access Validity: The Client is granted access to the enrolled educational level for a specified period of 60 days per level, with expiry reminders displayed in the student dashboard. License Type: The Client receives a "personal" license only to use the content, and may not transfer or sell it to others.',
      clause3Title: 'Intellectual Property and Content Protection',
      clause3Content: 'All educational materials (readable, audible, visual, audio recordings, and assessment tests) are the exclusive property of Englishom.com. Recording content, republishing it, or sharing the account with external parties is strictly prohibited. The platform reserves the right to cancel the subscription immediately and without compensation if any attempts to violate intellectual property rights are detected.',
      clause4Title: 'Payment and Subscription Policy',
      clause4Content: 'The subscription is activated upon payment confirmation by the administration or the automated system. Permissions are granted based on the enrolled level. In case of study interruption, the validity period remains active and missed days are not compensated, with the platform sending encouraging notifications to return to learning.',
      clause5Title: 'Privacy Policy and Data Protection',
      clause5Content: 'Data Collection: The platform collects basic data (name, email, study activity) to improve the educational experience. Progress Tracking: Data is used to track the Client\'s development and adherence to the personalized educational plan. Security: The Client is committed to maintaining the confidentiality of their account data, and the platform is not responsible for any breach resulting from the Client\'s negligence in protecting their password.',
      clause6Title: 'Certificates and Educational Results',
      clause6Content: 'The platform awards attendance certificates upon successful completion of levels according to the specified criteria for each course. Results and linguistic progress depend on the Client\'s commitment to daily practice (minimum 10 minutes daily) and following the comprehensive user guide instructions.',
      clause7Title: 'Applicable Law',
      clause7Content: 'This agreement is governed and interpreted in accordance with the laws and regulations in effect at the official headquarters of Englishom.com, and any dispute arising from it shall be resolved amicably or through the competent judicial authorities.',
      closing: 'By completing the payment, the Client acknowledges full commitment to the terms of this contract and to what is stated in the official "Terms and Conditions" and "Privacy Policy" pages of the platform. The subscriber pledges to maintain the confidentiality of the educational material available to them, including interactive texts, images, readable materials, and audio recordings, and acknowledges that these materials are designated for personal use within the platform interface only, and may not under any circumstances reproduce or publish them.',
    },
    testimonial: {
