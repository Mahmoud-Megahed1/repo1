...
export default {
  Landing: {
    ...
    levels: {
      title: 'Choose the appropriate technical track for your practice',
      subtitle: 'Customized programmatic tracks built according to smart flow algorithms',
      LEVEL_A1: {
        features: [
          'Initializing the first programming environment',
          'Activating the voice simulation feature',
          'Tracking mandatory audio updates',
          'Processing and matching the voiceprint',
          'Instant analysis of voice output accuracy',
        ],
      },
      LEVEL_A2: {
        features: [
          'Simulating live verbal interaction',
          'Algorithms for describing daily scenarios',
          'Interactive time-framing systems',
          'Advanced programmatic pronunciation processing',
          'Interactive situations databases',
        ],
      },
      LEVEL_B1: {
        features: [
      ...
      LEVEL_B2: {
        features: [
          ...
          'Technical compatibility analysis for voice',
        ],
      },
      LEVEL_C1: {
        features: [
          ...
          'Programmatic fluency analysis for pronunciation',
        ],
      },
      LEVEL_C2: {
        features: [
          'Comprehensive audio flow outputs',
          'Complex specialized text processing',
          'Complex interactive dialogue systems',
          'Strategic formulation challenges',
          'Comprehensive leadership speaking simulation',
        ],
      },
    },
    testimonials: {
    ...
    fqa: {
      ...
      questions: [
        {
          question: 'How does the daily training system work?',
          answer:
            'Every day, the system generates a set of interactive activities designed to build your skills progressively. This includes exercises and software simulations in reading, listening, speaking, and writing.',
        },
        {
          question: 'What tracks are available?',
          answer:
            'We offer six smart training tracks starting from the interactive foundation release system to the full professional simulation system. Each track is designed to help you develop your language skills step by step through our software solutions.',
        },
        {
          question: 'Can I track my progress?',
          answer:
            'Yes! You can monitor your daily performance and achievements through the smart analytics dashboard built into the platform.',
        },
        {
          question: 'Is there a mobile app?',
          answer:
            'Yes! The system interface and our technical environment are fully compatible with computers and mobile phones, allowing you to use and practice anytime, anywhere.',
        },
        {
          question: 'What are the privacy standards and data security?',
          answer:
            'Englishom platform relies on a fully automated software engineering, where data processing is limited to instant and automated interaction of systems with user behavior; to monitor the efficiency of completing solutions, process audio recordings, and automatically issue performance reports without any human intervention.\nAll data and track outputs are digital and fully encrypted, and no external parties or human cadres have the authority to view them. The system management - including operation scheduling, freezing, self-suspension, unfreezing, and report extraction - falls entirely on the user directly via their independent dashboard, within the highest approved technical protection and security standards.',
        },
      ],
    },
    cta: {
  ...
  TermsAndConditions: {
    ...
    sections: {
      acceptance: {
        ...
        content: {
          scope:
            '1.1 This document ("Terms and Conditions") represents a legal agreement between the user and Englishom software platform.',
          agreement:
            '1.2 Your use of the website or subscription to any of the services and technical systems means your complete and unconditional agreement to comply with these terms and conditions, which may be subject to modification at any time.',
          nature:
            '1.3 Nature of Service (Self-Training and Practice): The user acknowledges and agrees that the service provided is a programmed technical system and interactive tracks that rely entirely on independent use and self-learning. The website does not provide human teachers, classrooms, or live training sessions. Self-training relies on listening to integrated professional recordings and self-comparison through the software voice recording tool.',
        },
      },
      intellectualProperty: {
        ...
        content: {
          ownership:
            '2.1 Ownership: All website content, including texts, short stories, databases, basic words, daily sentences, timed 25-second challenges, audio recordings, automated evaluations, images, graphics, and system codes, are exclusive intellectual and technical property of Englishom.',
          prohibition:
            '2.2 Publication Prohibition: It is strictly forbidden to copy, republish, sell, distribute, or share any part of the digital tracks content or daily tasks of the systems online or offline.',
          personalUse:
            '2.3 Personal Use: The subscription grants you a limited digital license for personal non-commercial use only. Any violation of these terms will result in immediate account termination.',
        },
      },
      registration: {
        ...
        content: {
          personalAccount:
            '3.1 Personal Account: All registration information must be accurate and correct. The account is personal and dedicated to one user and cannot be shared; any evidence of account sharing is considered a material breach of cybersecurity for the systems and leads to immediate cancellation without refund.',
          pricing:
            '3.2 Pricing and Stability: The subscription price in the system is final and fixed for everyone across the technical platform. The website does not offer any family plans, student discounts, or any other unannounced price reductions.',
          paymentMethods:
            '3.3 Payment Methods: All payments and financial operations are made through secure and approved electronic payment gateways in Saudi Arabia (including Mada, Visa, Mastercard, and approved postpaid solutions).',
          refundPolicy:
            '3.4 Cancellation and Refund Policy (Final): Completing the purchase represents final approval and unconditional commitment from the user to benefit from the performance and technical systems. Given the nature of digital products and instant access to the system, all subscriptions are non-cancellable and non-refundable after completing the payment process. The user acknowledges their agreement that they have no right to demand compensation or refund from the website once their account is activated.',
        },
      },
      userResponsibility: {
        ...
        content: {
          recordingAccuracy:
            '4.1 Simulation Accuracy: The user acknowledges that the quality of training and self-correction depends on the quality and intention of the user in using their voice recording tool and comparing it with audio models within the system.',
          userBehavior:
            '4.2 User Behavior: All audio recordings and technical shares must be within the scope of respect and not posting any offensive, political, or illegal content that violates local regulations.',
          dataAndSecurity:
            '4.3 Data and Security: Personal data and your voice recordings are handled according to our displayed Privacy Policy, and they are used only to improve your technical experience and the system\'s interaction with you.',
        },
      },
      disclaimer: {
        ...
        content: {
          disclaimerStatement:
            '5.1 Disclaimer: The service and systems are provided "as is" without any warranties of any kind, express or implied, including, but not limited to, warranties of quality or fitness for a particular purpose.',
          results:
            '5.2 Results: The website does not guarantee achieving specific results, including inevitable success in job interviews or any other professional or academic goals, as results depend entirely on the user\'s seriousness, continuity, and perseverance in independent daily practice.',
          liability:
            '5.3 Liability Limits: In no event shall the website\'s liability for any losses or damages related to the technical system exceed the actual amount paid by the user for the last subscription.',
        },
      },
      termination: {
        ...
        content: {
          terminationRights:
            '6.1 Englishom has the right to terminate any user\'s subscription immediately without prior notice or refund in case of violation of any of these terms, especially clauses related to account sharing or infringement on intellectual and technical property rights of the platform.',
          accountDeletion:
            '6.2 The user has the right to request deletion of their account and all their data from the database at any time, by contacting the website\'s technical support team.',
        },
      },
    },
    contactInfo: {
  ...
  Global: {
    ...
    support: {
      note: 'Important Note: If you face any technical issues, please contact the support team via support@englishom.com.',
    ...
    lessonInstructions: {
      ...
      LISTEN: 'Listen to the conversation and learn the definitions',
      WRITE: 'Write the sentence you hear',
      SPEAK: 'Listen, record your voice, and compare pronunciation',
      TODAY: "Learn today's scene and practice pronunciation",
      Q_A: 'Read the question and listen to the answer',
      GRAMMAR: 'Learn the grammar rule and apply it',
      PHRASAL_VERBS: 'Learn phrasal verbs and their usage',
      IDIOMS: 'Learn idioms and their meanings',
      DAILY_TEST: 'Answer the questions to test what you learned today',
    },
    nextDay: 'Next Day {{day}}',
    dailySpeakingSuccess: "Well done! You have successfully completed today's practice",
    loading: 'Loading',
    ...
    loyaltyDiscountApplied: 'Loyalty Discount Applied ({{discount}}%)',
    ...
    progress: 'Progress',
    minPerDay: 'min/Day',
    chooseYourLevel: 'Choose Your Learning Track',
    level: 'Level {{level}}',
    ...
    purchaseAgreement: {
      ...
      checkboxLink: 'Smart Platform Usage License Agreement (Englishom)',
      proceedToPayment: 'Confirm & Purchase',
      fullAgreementTitle: 'Smart Platform Usage License Agreement (Englishom)',
      understood: 'Understood',
      intro: 'Last updated on June 1, 2026\n\nThis agreement constitutes a binding electronic contract and independent license terms between Englishom and the user (referred to as "the Client"), and applies to all purchases and activation of digital subscriptions in automated interactive solutions and systems.',
      clause1Title: 'Acceptance and Digital Licensing',
      clause1Content: 'Upon completing the technical payment process or activating the account, the Client acknowledges having read and agreed to all operational standards, terms and conditions, and the automation policy published on the website. This consent serves as a final, binding electronic signature for both parties.',
      clause2Title: 'Process Validity and System Tracks',
      clause2Content: '• Processing Validity: The automated system grants access to the activated digital track for a specified period of ({{days}} days) per track, and the validity timer appears automatically within the user account dashboard.\n• License Type: The Client receives a "personal and independent use" license for the software system interface, and may not transfer, sell, or delegate the account to others.',
      clause3Title: 'Technical Protection and Intellectual Property',
      clause3Content: 'All software components and interactive systems (including: smart texts, voice processing algorithms, databases, and automated performance proficiency tests) are the exclusive and classified property of the platform. Reverse engineering of the system, recording interfaces, republishing, or sharing the access code with external parties is strictly prohibited. The system reserves the right to immediately cancel the usage license and automatically track violations without compensation.',
      clause4Title: 'Payment Automation and Operation',
      clause4Content: 'Account validity is activated programmatically immediately after the payment process is confirmed through the automated system via payment gateways. In case of user interruption from operating the system, the validity time period remains active without pause and days are not programmatically compensated. The system sends automatic programmatic notifications to activate the account and continue practice.',
      clause5Title: 'Data Security and Automated Performance Monitoring',
      clause5Content: '• Data Processing: System monitoring is limited to basic data and programmatic user behavior for the purposes of improving automated response efficiency.\n• Performance Monitoring: Algorithms analyze user response to build statistical reports and language performance proficiency indicators automatically within an independent environment.\n• Account Protection: The responsibility of maintaining the confidentiality of the access code lies entirely with the user. The system is automated to close any account where access is detected from multiple and concurrent IP addresses.',
      clause6Title: 'Proficiency Reports and Track Outputs',
      clause6Content: 'The platform grants technical documents stating the successful completion of the digital track upon finishing the processes and solving all technical tasks according to the standards programmed within the system. Language proficiency outputs depend on the user\'s daily and self-interaction with simulation tools and matching the comprehensive programmed instructions of the platform.',
      clause7Title: 'Applicable System and Law',
      clause7Content: 'This agreement is subject to and interpreted according to the applicable systems and laws in the official headquarters of the platform and within technical and software service contracts. Any dispute arising from it shall be settled amicably or referred to the competent judicial authorities.',
      closing: '',
    },
    testimonial: {
