...
export default {
  ...
  Global: {
    ...
    purchaseAgreement: {
      ...
      description: 'Please read and accept the purchase agreement before proceeding',
      readFullAgreement: '📄 Read the full agreement',
      checkboxLabel: 'I confirm that I have read, understood, and agreed to all terms of the purchase and enrollment agreement for the training course on Englishom.com',
      ...
      clause1Content: 'By clicking "Agree" or completing the purchase, this constitutes a legally binding electronic signature confirming that you have read, understood, and fully agreed to all terms of this agreement.',
      clause2Title: 'Access Validity and License',
      clause2Content: 'The subscription grants access for 60 days to the specified level, with a non-transferable personal license. Account credentials may not be shared with any other person.',
      clause3Title: 'Intellectual Property Protection',
      clause3Content: 'All platform content (texts, audio recordings, images, tests) is the exclusive intellectual property of Englishom.com. Copying, republishing, or distributing any part of the content is prohibited. Any violation leads to immediate account termination.',
      clause4Title: 'Payment and No-Refund Policy',
      clause4Content: 'All payments are final and non-refundable after completing the payment process. Days of absence from study are not compensated. Completing the purchase represents final consent and unconditional commitment.',
      clause5Title: 'Privacy Policy and Data Security',
      clause5Content: 'Your personal data and audio recordings are handled according to our Privacy Policy. All data is encrypted, protected, and not shared with third parties.',
      clause6Title: 'Certificates and Results',
      clause6Content: 'Certificates are awarded based on completing the level and passing tests successfully. The website does not guarantee specific results as they depend on the user\'s diligence and perseverance.',
