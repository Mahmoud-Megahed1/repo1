...
export const translations = {
  ar: {
    ...
    footer: {
      ...
      contact: "تواصل معنا",
      links: [
        { label: "عن البرنامج", href: "https://englishom.com/about" },
      ...
      resourceLinks: [
        ...
        { label: "اختبار المستوى", href: "https://englishom.com/ques" },
        { label: "سياسة الخصوصية", href: "https://englishom.com/privacy" },
      ],
  ...
  en: {
    ...
    footer: {
      ...
      contact: "Contact Us",
      links: [
        { label: "About Program", href: "https://englishom.com/about" },
      ...
      resourceLinks: [
        ...
        { label: "Level Test", href: "https://englishom.com/ques" },
        { label: "Privacy Policy", href: "https://englishom.com/privacy" },
      ],
      email: "info@englishom.com",
      whatsapp: "966542577250",
