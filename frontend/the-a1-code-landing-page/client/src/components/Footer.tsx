      ...
      <div className="container">
        ...
        <div className={`grid grid-cols-1 md:grid-cols-2 gap-8 items-center ${isRTL ? "text-right" : ""}`}>
          ...
          <div className={`flex gap-3 flex-wrap ${isRTL ? "justify-start" : "justify-end"}`}>
            <a href="https://www.youtube.com/@EglishHOM" target="_blank" rel="noopener noreferrer" className="w-10 h-10 rounded-lg bg-[#FF0000] hover:bg-[#CC0000] flex items-center justify-center transition-all duration-300 hover:scale-110" title="YouTube">
              <Youtube className="w-5 h-5 text-white" />
            </a>
            <a href="https://x.com/englishom28264" target="_blank" rel="noopener noreferrer" className="w-10 h-10 rounded-lg bg-[#000000] hover:bg-[#333333] flex items-center justify-center transition-all duration-300 hover:scale-110" title="X">
