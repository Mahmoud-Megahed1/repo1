    ...
    <footer className="bg-[#222222] dark:bg-[#0a0a0a] text-white py-16 transition-colors duration-300">
      <div className="container">
        ...
        <div className={`grid grid-cols-1 md:grid-cols-2 gap-8 items-center pb-12 ${isRTL ? "text-right" : ""}`}>
          ...
          {/* Social Links - Padded to avoid floating WhatsApp button */}
          <div className={`flex gap-2 sm:gap-3 flex-wrap ${isRTL ? "justify-start pl-16 sm:pl-20" : "justify-end pr-16 sm:pr-20"}`}>
            <a href="https://www.youtube.com/@EglishHOM" target="_blank" rel="noopener noreferrer" className="w-9 h-9 sm:w-10 sm:h-10 rounded-xl bg-[#FF0000] hover:bg-[#CC0000] flex items-center justify-center transition-all duration-300 hover:scale-110 shadow-md" title="YouTube">
              <Youtube className="w-5 h-5 text-white" />
            </a>
            <a href="https://x.com/englishom28264" target="_blank" rel="noopener noreferrer" className="w-9 h-9 sm:w-10 sm:h-10 rounded-xl bg-[#000000] hover:bg-[#333333] flex items-center justify-center transition-all duration-300 hover:scale-110 shadow-md" title="X">
              <svg className="w-4 h-4 sm:w-5 sm:h-5 text-white" fill="currentColor" viewBox="0 0 24 24"><path d="M18.244 2.25h3.308l-7.227 8.26 8.502 11.24h-6.514l-5.106-6.694-5.829 6.694h-3.328l7.691-8.794-8.182-10.706h6.564l4.853 6.361 5.286-6.361zM16.17 18.933h1.829L5.896 5.009H4.013l12.157 13.924z"/></svg>
            </a>
            <a href="https://www.tiktok.com/@englishom1" target="_blank" rel="noopener noreferrer" className="w-9 h-9 sm:w-10 sm:h-10 rounded-xl bg-[#25F4EE] hover:bg-[#00D9D4] flex items-center justify-center transition-all duration-300 hover:scale-110 shadow-md" title="TikTok">
              <Music2 className="w-4 h-4 sm:w-5 sm:h-5 text-black" />
            </a>
            <a href={`https://wa.me/${t.footer.whatsapp}?text=%D9%85%D8%B1%D8%AD%D8%A8%D8%A7%D9%8B+%D8%A8%D9%83+%D9%81%D9%8A+Englishom+-+%D9%87%D9%84+%D9%84%D8%AF%D9%8A%D9%83+%D8%A3%D9%8A+%D8%A7%D8%B3%D8%AA%D9%81%D8%B3%D8%A7%D8%B1%D8%A7%D8%AA%D8%9F`} target="_blank" rel="noopener noreferrer" className="w-9 h-9 sm:w-10 sm:h-10 rounded-xl bg-[#25D366] hover:bg-[#1FA855] flex items-center justify-center transition-all duration-300 hover:scale-110 shadow-md" title="WhatsApp">
              <MessageCircle className="w-4 h-4 sm:w-5 sm:h-5 text-white" />
            </a>
            <a href="https://t.me/+xlzna51reL1hNzc0" target="_blank" rel="noopener noreferrer" className="w-9 h-9 sm:w-10 sm:h-10 rounded-xl bg-[#0088cc] hover:bg-[#006699] flex items-center justify-center transition-all duration-300 hover:scale-110 shadow-md" title="Telegram">
              <Send className="w-4 h-4 sm:w-5 sm:h-5 text-white" />
            </a>
            <a href="https://www.instagram.com/englishom1" target="_blank" rel="noopener noreferrer" className="w-9 h-9 sm:w-10 sm:h-10 rounded-xl bg-gradient-to-r from-[#f09433] to-[#e6683c] hover:from-[#d66d2d] hover:to-[#d6573d] flex items-center justify-center transition-all duration-300 hover:scale-110 shadow-md" title="Instagram">
              <Instagram className="w-4 h-4 sm:w-5 sm:h-5 text-white" />
            </a>
            <a href="https://www.snapchat.com/add/englishom25" target="_blank" rel="noopener noreferrer" className="w-9 h-9 sm:w-10 sm:h-10 rounded-xl bg-[#FFFC00] hover:bg-[#E6E600] flex items-center justify-center transition-all duration-300 hover:scale-110 shadow-md" title="Snapchat">
              <svg className="w-4 h-4 sm:w-5 sm:h-5 text-black" fill="currentColor" viewBox="0 0 24 24"><path d="M12.206.793c.99 0 4.347.276 5.93 3.821.529 1.193.403 3.219.299 4.847l-.003.06c-.012.18-.022.345-.03.51.075.045.203.09.401.09.3-.016.659-.12.917-.236.14-.065.27-.1.399-.1.243 0 .442.09.573.262.168.225.176.522.028.822a1.547 1.547 0 0 1-.06.107c-.219.37-.737.597-1.464.67a3.414 3.414 0 0 0-.18.018c-.064.006-.148.015-.21.02a.612.612 0 0 0-.367.17c-.094.118-.13.283-.106.49.184 1.455.975 2.86 2.357 4.187a.85.85 0 0 1 .19.285c.072.213-.038.425-.28.567-1.074.634-2.235.77-3.3.88a32.7 32.7 0 0 0-.205.024c-.118.015-.177.045-.21.09-.066.087-.049.245-.032.378.011.09.024.18.024.27 0 .37-.225.638-.636.638a3.43 3.43 0 0 1-.637-.076 5.307 5.307 0 0 0-1.098-.137c-.416 0-.816.064-1.155.195a4.338 4.338 0 0 0-.774.448c-.564.39-1.201.832-2.2.832-.026 0-.053 0-.077-.002h-.06c-1-.002-1.637-.444-2.2-.833a4.357 4.357 0 0 0-.775-.45 3.496 3.496 0 0 0-1.154-.193c-.39 0-.772.043-1.098.137a3.426 3.426 0 0 1-.638.076c-.412 0-.636-.268-.636-.638 0-.09.012-.18.024-.27.017-.134.034-.29-.032-.378-.034-.046-.093-.076-.21-.09a34.12 34.12 0 0 0-.206-.025c-1.064-.11-2.225-.245-3.3-.88-.24-.14-.35-.353-.277-.566a.85.85 0 0 1 .19-.286c1.381-1.326 2.173-2.732 2.357-4.187.024-.207-.012-.372-.106-.49a.614.614 0 0 0-.366-.17 1.766 1.766 0 0 0-.21-.02 3.592 3.592 0 0 1-.18-.018c-.727-.073-1.245-.3-1.465-.67a1.508 1.508 0 0 1-.059-.107c-.148-.3-.14-.597.028-.822.13-.172.33-.262.573-.262.13 0 .26.035.398.1.258.116.618.22.917.236.198 0 .326-.045.401-.09-.008-.165-.018-.33-.03-.51l-.003-.06c-.104-1.628-.23-3.654.3-4.847C7.648 1.069 11.004.793 11.994.793h.212z"/></svg>
            </a>
            <a href="https://www.facebook.com/share/19wWacNacT/" target="_blank" rel="noopener noreferrer" className="w-9 h-9 sm:w-10 sm:h-10 rounded-xl bg-[#1877F2] hover:bg-[#1565D8] flex items-center justify-center transition-all duration-300 hover:scale-110 shadow-md" title="Facebook">
