export function AverageTestTime() {
  const testTimes = [
    { name: 'اختبار الكفاءة', time: '12 دقيقة', icon: '📊' },
    { name: 'اختبار السرعة', time: '8 دقائق', icon: '⚡' },
    { name: 'اختبار الاستماع', time: '15 دقيقة', icon: '🎧' },
  ];
      ...
      <div className="relative z-10">
        ...
        <div className="mt-4 p-3 bg-gradient-to-r from-orange-500/10 to-red-500/10 rounded-lg border border-orange-500/20">
          <p className="text-xs text-gray-400">
            💡 <span className="text-orange-300">نصيحة:</span> جرب الاختبارات الآن واختبر مستواك الحقيقي!
          </p>
        </div>
      </div>
