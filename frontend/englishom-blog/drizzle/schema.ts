...
export const blogPosts = mysqlTable("blog_posts", {
  ...
  customAuthorNameEn: varchar("customAuthorNameEn", { length: 255 }),
  customAuthorNameAr: varchar("customAuthorNameAr", { length: 255 }),
  showDate: boolean("showDate").default(true),
  dateDisplayType: varchar("dateDisplayType", { length: 20 }).default("published"),
